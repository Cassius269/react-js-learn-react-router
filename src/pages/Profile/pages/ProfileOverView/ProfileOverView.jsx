...
function ProfileOverView() {
  ...
  const handleClick = () => {
    console.log("hello");
    navigate("data"); // naviguer vers le chemin relatif à partir du chemin courant
  };
  return (
    <>
      <h1>Je suis la page vue globale du profile utilisateur</h1>
      <ul>
        <li className="mt-3">
        ...
        <button
          onClick={handleClick}
          type="button"
          className="btn btn-outline-danger mt-5 d-block m-auto"
        >
          Naviguer vers la page data
        </button>
        <li className="mt-5">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia
          asperiores voluptatem architecto inventore hic voluptatibus, harum ex
